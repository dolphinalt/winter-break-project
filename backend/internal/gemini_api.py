...
RECIPE_JSON_SCHEMA = {
    ...
    "properties": {
        "recipes": {
            "type": "array",
            "description": "A list of 3 creative recipe suggestions generated from the ingredients.",
            "items": {
                "type": "object",
                "properties": {
                    "dish_name": {
...
def generate_structured_recipes(image_url: str) -> dict:
    ...
    prompt_text = (
        ...
        "3. GENERATION: Generate 3 distinct, creative, and practical recipe suggestions. "
        "Prioritize recipes that maximize the use of the visible ingredients while maintaining high flavor. "
        "Ensure variety in cuisine types (e.g., don't make all 3 recipes pasta). "
